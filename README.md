...
TerraFuse is an early prototype of a drag-and-drop web environment for geospatial data fusion. The first slice focuses on H3-backed cell aggregation, browser-based visualization, and a full-stack project shape that can grow into server-side ingest, analysis, collaboration, and operator-room workflows.
...
- Render fused cell layers on a WebGL map with deck.gl.
...
- `apps/web`: React, Vite, deck.gl, MapLibre UI.
